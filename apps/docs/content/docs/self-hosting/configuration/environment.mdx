...
| `NEXT_PUBLIC_SOURCE_URL`           | Public source URL shown in the footer                        | Hidden when unset                |
...
| `NEXT_PRIVATE_POSTMARK_WEBHOOK_USERNAME` | -        | HTTP Basic Auth username for the Postmark delivery-failure webhook |
| `NEXT_PRIVATE_POSTMARK_WEBHOOK_PASSWORD` | -        | HTTP Basic Auth password for the Postmark delivery-failure webhook |
