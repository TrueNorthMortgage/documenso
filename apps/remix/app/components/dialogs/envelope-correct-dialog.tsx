          ...
          <Alert variant="warning">
            ...
            <AlertDescription>
              <Trans>
                ...
                create a new draft copy. All recipients must complete the corrected document again and will receive new
                signing links when you send it. Your normal cancellation notification settings apply to the original.
              </Trans>
            </AlertDescription>
          </Alert>
        ) : (
