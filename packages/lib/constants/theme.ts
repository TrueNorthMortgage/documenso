...
export const DEFAULT_BRAND_COLORS = {
  ...
  fieldCard: '#fdeddc', //               30.91 89.19% 92.75%
  fieldCardBorder: '#edae83', //         24.34 74.65% 72.16%
  ...
  primary: '#edae83', //                 24.34 74.65% 72.16%
  primaryForeground: '#2d1406', //       22.21 76.37% 10%
