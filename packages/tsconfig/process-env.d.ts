declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    SELF_HOSTED_OIDC_AUTO_PROVISION_ENABLED?: string;
    SELF_HOSTED_OIDC_TEAM_DOMAIN_MAP?: string;
    SELF_HOSTED_PENDING_PREPARATION_TTL_SECONDS?: string;
    ...
    NEXT_PRIVATE_POSTMARK_WEBHOOK_USERNAME?: string;
    NEXT_PRIVATE_POSTMARK_WEBHOOK_PASSWORD?: string;
