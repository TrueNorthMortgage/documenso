  ...
  return (
    <FieldContainerPortal field={field}>
      <div
        ...
        className={cn(
          'field--FieldRootContainer field-card-container dark-mode-disabled group relative z-20 flex h-full w-full items-center rounded-[2px] bg-transparent ring-2 ring-gray-200 transition-all',
          color?.base,
          {
